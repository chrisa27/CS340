...
public class EventIDProxyTest {
    ...
    public void invalidToken(){
        ...
        EventResponse test = ProxyServer.SINGLETON.event(it.next().getEventID(), "55");
    ...
    public void invalidID(){
        EventResponse test = ProxyServer.SINGLETON.event("66", token);
    ...
    public void idTest(){
        Iterator<Event> it = events.iterator();
        Event event = it.next();
        EventResponse test = ProxyServer.SINGLETON.event(event.getEventID(), token);
