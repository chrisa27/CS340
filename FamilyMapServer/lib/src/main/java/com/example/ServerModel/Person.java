...
public class Person {
    ...
    private static Set<String> maleNames = populateNames("C:\\Users\\video\\AndroidStudioProjects\\FamilyMapServer\\lib\\src\\main\\java\\libs\\json\\mnames.json");
    private static Set<String> femaleNames = populateNames("C:\\Users\\video\\AndroidStudioProjects\\FamilyMapServer\\lib\\src\\main\\java\\libs\\json\\fnames.json");
    private static Set<String> surnames = populateNames("C:\\Users\\video\\AndroidStudioProjects\\FamilyMapServer\\lib\\src\\main\\java\\libs\\json\\snames.json");
    private static Set<Location> locations = populateLocations("C:\\Users\\video\\AndroidStudioProjects\\FamilyMapServer\\lib\\src\\main\\java\\libs\\json\\locations.json");
    ...
    public Person(String firstName, String lastName, String gender) {
        ...
        mother = null;
        spouse = null;
        lifeEvents = generateEvents(personID, descendant, 0);
    }
    ...
    private Person generatePerson(String gender, int personBirth) {
        ...
        Person person = new Person(descendant, first, last, gender);
